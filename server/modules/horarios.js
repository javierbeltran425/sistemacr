...
const createHorario = async function (req, res) {
    ...
    try {
        const newSolicitud = await knex('horarios').insert({ id_usuario: id_usuario, id_materia: id_materia, titulo: title, descripcion: description, hora_inicio: start, hora_final: end })
