...
const whatsappMail = tryCatch(function (req, res) {
  const { to } = req.body;

  var botId = "113381458451143";
  var phoneNbr = to;
  var bearerToken =
    "EAANef7SZBzsMBAOvZAAZBrsI9w9ZCRtP8YUBOUZAmXgpNfrZA6kViZBI95gS1YQGKYWKCMQHFKI5j8shT1QkcbUkZAZCN9SZA69p3S97cllt8K7frfvZC6rPcLpTQb3SQhJpHJkcY1FqMZABdfQc8emXZAXQeWdYrwEKTl0J4RAgzPtWJClm7VXgidcvwmBEzomW7zzaKgFaITYR4KgGzXafRWLFl";
